...
//	public Element createPreface(){
//		Element pre=preface.addElement("<!--Generated by SWIFT Editor (build:R1.6.5.1) on 2019 Sep 26 17:22:51-->");
//		return pre;
//	}
...
//		String name=ListToTree.namespaces;
		Date d=new Date();
		...
		root.addAttribute("targetNamespace", "urn:cufir:std:cufir:20022:tech:xsd:"+ListToTree.namespaces);
		return root;
	}
	...
	private Element createBody() {
		...
		body.addAttribute("name", "AuthstnReq");
		return body;
	}
	 ...
	 * 构造End
	 */
	private Element createEnd() {
		Element end=request.addElement("xs:element");
		end.addAttribute("name", "SctyTrlr");
		return end;
	}
	...
	private Element createRequest() {
		...
		//
		Element complexType=request.addElement("xs:complexType").addAttribute("name", "Document");
		
		Element sqeuence=complexType.addElement("xs:sequence");
		
//		String fileName=ListToTree.fileName;
//		String fileName_type=ListToTree.fileName_xmlTag;
		Element el=sqeuence.addElement("xs:element").addAttribute("name",ListToTree.fileName).addAttribute("type",ListToTree.fileName_xmlTag);
		//
//		header=sqeuence.addElement("xs:elemnet");
//		header.addAttribute("name", "Hdr");
//		header.addAttribute("type", "Header");
//		//
//		body=sqeuence.addElement("xs:element");
//		body.addAttribute("name", "AuthstnReq");
//		
//		end=sqeuence.addElement("xs:element");
//		end.addAttribute("name", "SctyTrlr");
		return request;
	}
	...
	public void addSimpleType(String name,List<ElementNode> node) {
		...
		//List<SimpleBean> nods=node.getCodes();
		//添加元素
		ArrayList<Object> list=new ArrayList<>();
...
//	
	...
	public void writeToDisk(String path) {
		try {
			...
			//String path="D:\\XSchema";
			File file=new File(path);
			if (!file.exists()) {
				file.createNewFile();
			}
			XMLWriter writer=new XMLWriter(new FileWriter(
							new File(path)),format);//"test.xsd"
