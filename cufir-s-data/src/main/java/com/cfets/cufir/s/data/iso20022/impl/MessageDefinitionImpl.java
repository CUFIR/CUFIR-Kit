 ...
 * </p>
 * <ul>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getMessageSet <em>Message Set</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getXmlName <em>Xml Name</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getXmlTag <em>Xml Tag</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getBusinessArea <em>Business Area</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getXors <em>Xors</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getRootElement <em>Root Element</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getMessageBuildingBlock <em>Message Building Block</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getChoreography <em>Choreography</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getMessageDefinitionIdentifier <em>Message Definition Identifier</em>}</li>
 *   <li>{@link com.cfets.cufir.s.data.iso20022.impl.MessageDefinitionImpl#getDerivation <em>Derivation</em>}</li>
 * </ul>
 *
 * @generated
 */
