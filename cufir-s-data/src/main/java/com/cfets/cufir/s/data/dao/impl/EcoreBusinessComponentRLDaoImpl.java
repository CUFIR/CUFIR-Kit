 ...
 *
 */
public class EcoreBusinessComponentRLDaoImpl implements EcoreBusinessComponentRLDao{

	private static Logger logger = Logger.getLogger(EcoreBusinessComponentRLDaoImpl.class);
