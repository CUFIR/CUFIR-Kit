 ...
 *
 */
public class EcoreBusinessProcessDaoImpl implements EcoreBusinessProcessDao{

	private static Logger logger = Logger.getLogger(EcoreBusinessProcessDaoImpl.class);
