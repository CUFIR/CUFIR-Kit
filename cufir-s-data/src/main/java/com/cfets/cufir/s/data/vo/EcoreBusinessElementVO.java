...
public class EcoreBusinessElementVO {
	...
	public EcoreBusinessElement getEcoreBusinessElement() {
		return ecoreBusinessElement;
	}
	public void setEcoreBusinessElement(EcoreBusinessElement ecoreBusinessElement) {
		this.ecoreBusinessElement = ecoreBusinessElement;
	}
