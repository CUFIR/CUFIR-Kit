...
public class DerbyUtil {
	...
	public static void main(String[] args) {
		try {
			String dburl = "C://Users//tangmaoquan_ntt//Desktop//cide-2.0.0//config//db";
//			System.out.println(Platform.getInstallLocation().getURL().getPath().replaceFirst("/", "").replace("/", "//"));
			String connUrl = "jdbc:derby:" + dburl + ";create=false";
			URL_SHUTDOWN = "jdbc:derby:" + dburl + ";shutdown=true";
			logger.info("数据库URL=" + connUrl);
			System.out.println("数据库URL=" + connUrl);
			Class.forName(Constant.DRIVER);
