...
public class ImgUtil {
	...
	public static String MC_SUB4_COMPONENT = "/icons/MessageComponent_Obsolete_lock.png";
	...
	public static String MC_SUB4_CHOICE = "/icons/ChoiceComponent_Obsolete_lock.png";
	/**
	 * 元素图片地址
	 */
	...
	public static String MD_SUB4 = "/icons/Message_Definition_Obsolete.png";
	/**
	 * 组件图片地址
	 */
	...
	public static Image getImage(String imgPath) {
		Image img = Activator.imageDescriptorFromPlugin(Activator.PLUGIN_ID, imgPath).createImage();
		return img;
	}
}
