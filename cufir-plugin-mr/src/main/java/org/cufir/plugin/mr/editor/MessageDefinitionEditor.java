...
public class MessageDefinitionEditor extends MrMultiPageEditor {
	...
	void createSummaryPage() {
		...
		MouseAdapter mouseAdapter = new MouseAdapter() {
			...
			public void mouseUp(MouseEvent e) {
				String name = MrEditorHelper.generateName(nameText.getText(), mds);
		...
		if (msgDefinition != null && msgDefinition.getId() != null) {
			MrEditorHelper.setSynonymsTable(synonymsTable, msgDefinition.getId(), null);
		}
		// ========== Synonyms Group End ==========================================
		...
		if (msgDefinition != null && msgDefinition.getId() != null) {
			MrEditorHelper.setExamplesTable(examplesTable, msgDefinition.getId());
		}
		// =================== Exampel Group End ==============================
	...
	public void setPreviousVersion(Map<String, EcoreMessageDefinition> emdMapById) {
		...
		java.util.List<EcoreNextVersions> EcoreNextVersionses = MrEditorHelper.getPreviousVersions(envMapByNextVersionId, msgDefinition.getId(), list);
