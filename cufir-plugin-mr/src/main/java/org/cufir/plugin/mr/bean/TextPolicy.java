...
public class TextPolicy {
	 ...
	 * 文本搜索
	 */
	public static final int TEXT_BUTTON_SELECT_TYPE = 6;
	
	/**
	 * 内容一般文本
	 */
	public static final int TEXT_CONTENT_COMMONLY_TYPE = 7;
	
	/**
	 * 内容富文本
	 */
	public static final int TEXT_CONTENT_SCROLL_TYPE = 8;
	
	/**
	 * 内容描述
	 */
	public static final int TEXT_CONTENT_NOTE_ONE_TYPE = 9;
	
	/**
	 * 内容描述
	 */
	public static final int TEXT_CONTENT_NOTE_TWO_TYPE = 10;
	
	/**
	 * 内容短文本
	 */
	public static final int TEXT_CONTENT_SHORT_TYPE = 11;
	
	/**
	 * 内容文本搜索
	 */
	public static final int TEXT_CONTENT_BUTTON_SELECT_TYPE = 12;
