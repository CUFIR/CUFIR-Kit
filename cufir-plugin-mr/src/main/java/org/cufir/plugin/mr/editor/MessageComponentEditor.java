...
public class MessageComponentEditor extends MrMultiPageEditor {
	...
	private Text meNameText, meDocText, meMinOccursText, meMaxOccursText, meTypeText, meXmlTagText, bcTypeText;
//	private Combo meStatusCombo;
	 ...
	 * @param createImg
	 */
	private void setTitleIma(Image createImg) {
		this.setTitleImage(createImg);
	}
	...
	public void init(IEditorSite site, IEditorInput input) throws PartInitException {
		this.setSite(site);
		this.setInput(input);
		this.setPartProperty(MrHelper.SAVE_CUSTOM_NAME, TreeMenuEnum.MESSAGE_COMPONENTS.getName());
		...
		if (msgComponent != null) {
			...
			if("2".equals(msgComponent.getComponentType())) {
				...
				}else if (msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Provisionally.getStatus())) {
					this.setTitleImage(ImgUtil.createImg(ImgUtil.MC_SUB4_CHOICE));
				}else {
				...
				if (msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Registered.getStatus())
					...
					this.setTitleImage(ImgUtil.createImg(ImgUtil.MC_SUB4_COMPONENT));
				}else {
	...
	public void setDirty(boolean dirty) {
		...
		} else if (dirty && (msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Registered.getStatus())
				|| msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Obsolete.getStatus()))) {
			...
			public void mouseUp(MouseEvent e) {
				...
				if (!choiceButton.getSelection()) {
					if (msgComponent == null) {
						...
						setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB3_COMPONENT));
					} else {
						if (msgComponent.getRegistrationStatus() == null 
								|| msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Provisionally.getStatus())
								|| msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Added.getStatus())) {
							modelExploreTreeItem.setImage(ImgUtil.createImg(ImgUtil.MC_SUB3_COMPONENT));
							setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB3_COMPONENT));
						}else if (msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Obsolete.getStatus())) {
							modelExploreTreeItem.setImage(ImgUtil.createImg(ImgUtil.MC_SUB4_COMPONENT));
							setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB4_COMPONENT));
						}else {
							modelExploreTreeItem.setImage(ImgUtil.createImg(ImgUtil.MC_SUB1_COMPONENT));
							setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB1_COMPONENT));
						}
					}
				} else {
					if (msgComponent == null) {
						modelExploreTreeItem.setImage(ImgUtil.createImg(ImgUtil.MC_SUB1_CHOICE1));
						setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB1_CHOICE1));
					} else {
						if (msgComponent.getRegistrationStatus() == null) {
							modelExploreTreeItem.setImage(ImgUtil.createImg(ImgUtil.MC_SUB1_CHOICE1));
							setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB1_CHOICE1));
						} else {
							if (msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Provisionally.getStatus())
									|| msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Added.getStatus())) {
								modelExploreTreeItem.setImage(ImgUtil.createImg(ImgUtil.MC_SUB1_CHOICE1));
								setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB1_CHOICE1));
							}else if (msgComponent.getRegistrationStatus().equals(RegistrationStatusEnum.Obsolete.getStatus())) {
								modelExploreTreeItem.setImage(ImgUtil.createImg(ImgUtil.MC_SUB4_CHOICE));
								setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB4_CHOICE));
							} else {
								modelExploreTreeItem.setImage(ImgUtil.createImg(ImgUtil.MC_SUB1_CHOICE));
								setTitleIma(ImgUtil.createImg(ImgUtil.MC_SUB1_CHOICE));
							}
						}
					}
				}
	...
	void createContentPage() {
		...
		addMessageElementBtn.addMouseListener(new MouseAdapter() {
			...
			private void addMessageElementDetailBar(Composite rightComposite, ScrolledComposite scrolledComposite,
				...
				Button typeButton = new SummaryRowTextComposite(rightComposite, new ButtonPolicy(ButtonPolicy.BUTTON_CONTENT_TYPE_PUSH_DEEP,"choose")).getButton();
				...
				Button finishButton = new SummaryRowTextComposite(rightComposite, new ButtonPolicy(ButtonPolicy.BUTTON_CONTENT_TYPE_PUSH_DEEP, "Finish")).getButton();
				...
				Button cancelButton = new SummaryRowTextComposite(rightComposite, new ButtonPolicy(ButtonPolicy.BUTTON_CONTENT_TYPE_PUSH_DEEP,"Cancel")).getButton();
		...
		if (msgElementList != null && msgElementList.size() > 0) {
			for (EcoreMessageElementVO ecoreMessageElementVO : msgElementList) {
				...
				if (summaryStatusCombo.getText().equals(RegistrationStatusEnum.Added.getStatus()) || summaryStatusCombo.getText() == null) {
					treeItem.setData("mcstatus", 1);
				}
				...
				if (summaryStatusCombo.getText() != null) {
					if (summaryStatusCombo.getText().equals(RegistrationStatusEnum.Registered.getStatus()) || summaryStatusCombo.getText().equals(RegistrationStatusEnum.Obsolete.getStatus())) {
		...
		if (this.msgElementList != null && this.msgElementList.size() > 0) {
			for (EcoreMessageElementVO msgElementVO : msgElementList) {
				...
				if ("2".equals(msgElement.getType())) {// 1：datatype，2：消息组件
					...
					if (status == null || status.equals(RegistrationStatusEnum.Provisionally.getStatus())
							|| status.equals(RegistrationStatusEnum.Added.getStatus())) {
			...
			public void mouseDown(MouseEvent event) {
				...
				if (event.button == 3) {
					...
					if (msgComponent != null
						...
						if (status.equals(RegistrationStatusEnum.Registered.getStatus()) || status.equals(RegistrationStatusEnum.Obsolete.getStatus())) {
...
//					
	...
	void createImpactPage() {
		...
		msgComponentTableCursor.addMouseListener(new MouseAdapter() {
			...
			public void mouseUp(MouseEvent e) {
				...
				if (status == null || status.equals(RegistrationStatusEnum.Provisionally.getStatus()) || status.equals(RegistrationStatusEnum.Added.getStatus())) {
	...
	public void setPreviousVersion(Map<String, EcoreMessageComponent> emcMapById) {
		...
		java.util.List<EcoreNextVersions> EcoreNextVersionses = MrEditorHelper.getPreviousVersions(envMapByNextVersionId, messageComponentId, list);
		...
		try {
			...
			if (name.equals("")) {
				...
				if(count > 0) {
					...
					String previousVersion = MrEditorHelper.getVersion(name, p, split);
					if("0".equals(previousVersion)) {
						MessageDialog.openWarning(Display.getDefault().getActiveShell(), I18nApi.get("tips.name"), I18nApi.get("tips.error.name.version"));
						return;
					}else {
	...
	public EcoreMessageComponentVO getAllData() {
		...
		for (int i = 0; i < messageElementsTreeItem.length; i++) {
			...
			ecoreMessageElement.setRegistrationStatus(item.getData("meStatusCombo") == null ? RegistrationStatusEnum.Added.getStatus()
	...
	private void showMessageElementDetailBar(TreeItem treeItem, Composite rightComposite) {
		...
		new SummaryRowTextComposite(rightComposite, new TextPolicy(TextPolicy.TEXT_CONTENT_COMMONLY_TYPE, 458, "Object Identifier", false, meObjectIdentifier)).getText();
		// -----------------------CMP Information Group End -----------------------
	...
	private void showCodeDetailBar(TreeItem treeItem, Composite rightComposite) {
		...
		new SummaryRowTextComposite(rightComposite, new TextPolicy(TextPolicy.TEXT_CONTENT_COMMONLY_TYPE, 45, "Name", false, name)).getText();
		
		String codeDocument = treeItem.getData("Document") == null ? "" : treeItem.getData("Document") + "";
		new SummaryRowTextComposite(rightComposite, new TextPolicy(TextPolicy.TEXT_CONTENT_SCROLL_TYPE, 73, "Documentation", false, codeDocument)).getText();
		
		String codeName = treeItem.getData("CodeName") == null ? "" : treeItem.getData("CodeName") + "";
		new SummaryRowTextComposite(rightComposite, new TextPolicy(TextPolicy.TEXT_CONTENT_COMMONLY_TYPE, 228, "CodeName", false, codeName)).getText();
		// ------------ Code Details End ---------------------------------
		// -----------------------CMP Information Group Begin -----------------------
		...
		new SummaryRowTextComposite(rightComposite, new TextPolicy(TextPolicy.TEXT_CONTENT_COMMONLY_TYPE, 318, "Object Identifier", false, objectIdentifier)).getText();
	...
	public void changeStatus() {
		if (msgComponent == null) {
			...
			if (msgComponent.getRegistrationStatus() == null) {
				...
				if (status.equals(RegistrationStatusEnum.Registered.getStatus()) || status.equals(RegistrationStatusEnum.Obsolete.getStatus())) {
					changeEditor();
				} else if (status.equals(RegistrationStatusEnum.Added.getStatus()) || status.equals(RegistrationStatusEnum.Provisionally.getStatus())) {
