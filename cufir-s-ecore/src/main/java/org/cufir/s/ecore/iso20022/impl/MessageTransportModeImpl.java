 ...
 * </p>
 * <ul>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getBoundedCommunicationDelay <em>Bounded Communication Delay</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMaximumClockVariation <em>Maximum Clock Variation</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMaximumMessageSize <em>Maximum Message Size</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMessageDeliveryWindow <em>Message Delivery Window</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMessageSendingWindow <em>Message Sending Window</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getDeliveryAssurance <em>Delivery Assurance</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getDurability <em>Durability</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMessageCasting <em>Message Casting</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMessageDeliveryOrder <em>Message Delivery Order</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMessageValidationLevel <em>Message Validation Level</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMessageValidationOnOff <em>Message Validation On Off</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getMessageValidationResults <em>Message Validation Results</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getReceiverAsynchronicity <em>Receiver Asynchronicity</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getSenderAsynchronicity <em>Sender Asynchronicity</em>}</li>
 *   <li>{@link org.cufir.s.ecore.iso20022.impl.MessageTransportModeImpl#getBusinessTransaction <em>Business Transaction</em>}</li>
 * </ul>
 *
 * @generated
 */
